...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen text-white flex flex-col relative overflow-hidden">
      ...
      {/* Background Decor */}
      <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-[#e60000]/10 rounded-full blur-[120px]" />
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative group">
              <Mail className="absolute left-4 top-3.5 text-slate-500 group-focus-within:text-[#e60000] transition-colors" size={20} />
              <input
                type="email"
                placeholder="EMAIL ADDRESS"
                required
                className="w-full bg-[#0a0a0a]/50 border border-white/10 text-white pl-12 pr-4 py-3 focus:outline-none focus:border-[#e60000]/50 transition-colors font-mono text-sm"
            ...
            <div className="relative group">
              <Lock className="absolute left-4 top-3.5 text-slate-500 group-focus-within:text-[#e60000] transition-colors" size={20} />
              <input
                type="password"
          ...
          <div className="mt-6 text-center text-sm text-slate-500">
            NEW AGENT?{" "}
            <Link href="/register" className="text-[#e60000] hover:underline font-bold">
              REGISTER HERE
            </Link>
          </div>
        </motion.div>
