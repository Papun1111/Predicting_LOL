...
export default function PredictionResult({ result }) {
  ...
  const winColor = isBlueWin ? "#3b82f6" : "#ef4444"; // Team-contextual blue/red
  ...
  return (
    <motion.div 
      ...
      className="mt-8 space-y-10 bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/8 rounded-2xl p-8 relative overflow-hidden shadow-2xl"
    >
      ...
      <div 
        ...
        style={{ backgroundColor: isBlueWin ? "#ef4444" : "#3b82f6" }}
      />
      ...
      <div className="text-center relative z-10">
        ...
        <div className="w-24 h-1 mx-auto mt-4 rounded-full bg-[#e60000]" style={{ boxShadow: '0 0 10px rgba(230,0,0,0.5)' }} />
      </div>
      ...
      {/* X-Ray SHAP Factors */}
      <div className="relative z-10 mt-12 bg-[#0a0a0a]/80 p-6 rounded-xl border border-white/5">
          ...
          {shapData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="h-1.5 w-full bg-[#1a1a1a] rounded-full relative overflow-hidden border border-white/5">
